...
function RPSeededRooms:BossRush()
  ...
  if bossRushRoll <= 30 then
    ...
    -- (same as room #0)
    RPSeededRooms:SpawnPedestal(11, 5)
    RPSeededRooms:SpawnPedestal(14, 5)
    RPSeededRooms:SpawnPedestal(11, 8)
    RPSeededRooms:SpawnPedestal(14, 8)
  ...
  elseif bossRushRoll <= 51 then
    ...
    for x = 11, 14 do
      RPSeededRooms:SpawnPedestal(x, 5)
      RPSeededRooms:SpawnPedestal(x, 8)
    end
  end
...
function RPSeededRooms:DevilRoom()
  ...
  elseif roomRoll <= 110 then
    ...
    RPSeededRooms:SpawnPedestalShop(6, 4)
  ...
  elseif roomRoll <= 210 then
    ...
    RPSeededRooms:SpawnPedestalShop(5, 4)
  ...
  elseif roomRoll <= 310 then
    ...
    RPSeededRooms:SpawnPedestalShop(7, 4)
  ...
  elseif roomRoll <= 1695 then
    ...
    for x = 4, 8 do
      if x % 2 == 0 then
        RPSeededRooms:SpawnPedestalShop(x, 4)
      end
    end
    ...
    for x = 3, 9 do
      for y = 3, 4 do
        if (y == 3 and (x == 3 or x == 9)) or
          ...
          RPSeededRooms:SpawnPedestalShop(x, y)
        end
      end
    end
  end
...
function RPSeededRooms:AngelRoom()
  ...
  if roomRoll <= 12 then
    -- 12x 2 pedestals (12 weight)
    RPSeededRooms:SpawnPedestal(4, 4)
    RPSeededRooms:SpawnPedestal(8, 4)
  ...
  elseif roomRoll <= 13 then
    ...
    RPSeededRooms:SpawnPedestal(0, 0)
    RPSeededRooms:SpawnPedestal(12, 0)
    RPSeededRooms:SpawnPedestal(0, 6)
  ...
  elseif roomRoll <= 14 then
    ...
    RPSeededRooms:SpawnPedestal(6, 4)
...
function RPSeededRooms:SpawnPedestal(x, y)
  -- Local variables
  local game = Game()

  -- Spawn it with a seed of 0 so that it gets replaced on the next frame
  local pos = RPGlobals:GridToPos(x, y)
  game:Spawn(EntityType.ENTITY_PICKUP, PickupVariant.PICKUP_COLLECTIBLE, -- 100
             pos, Vector(0, 0), nil, 0, 0)
end

function RPSeededRooms:SpawnPedestalShop(x, y)
  -- Local variables
  local game = Game()
