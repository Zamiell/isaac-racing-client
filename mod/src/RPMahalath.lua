...
local bal = {
  ...
  JumpSpeed = {10, 12},
  BoredomLimit = 6,
  FirstState = {'idle', 'queasy'},
  T2HealthBuff = 0,
  TransformPercent = {.6, .55},
  IdleRetargetRate = {50, 20},
  ShotgunIdleTime = {18, 7},
  ShotgunIdleVariance = {10, 4},
  T2ExtraShotgunRate = 35,
  ShotgunSpreadMax = {65, 105},
  SpinBarfTime = {120, 60},
  SpinBarfFireRate = {3, 2},
  SpinBarfRotation = {125, 274},
  BallKnockerHitLimit = {5, 8},
  BaseballIdleTime = {20, 5},
  BarfBallsIdleTime = {50, 10},
  ShootBallIdleTime = {25, 5},
  BarfBubbleSize = {1.5, 1.75},
  SpitTearSpeed = {3, 11},
  SpitTearAngle = {30, 22},
  ShootBallSpeed = {5, 6},
  SuckMaxSuck = {220, 240},
  SuckIncreaseRate = {1, 1.3},
  ShotgunHomingRate = {.09, .18},
  T2BallSpeedTarget = 2.2,
  MoveAvoidAccel = {.4, .7},
  MoveMouthBlockRange = {220, 140},
  MoveAlignXAccel = {.25, .45},
  MoveSlowFollowSpeed = {4, 7},
  MoveBouncyChaseSpeed = {4, 4},
  MoveBallKnockerAccel = {1.2, 1.3},
  MoveBallKnockerSpeed = {5, 5.5},
  MoveBallKnockerACorrect = {4.2, 6},
  BallKnockSpeed = {8, 11},
