...
local wraithMeterXOffset1 = 45 --Wraith Meter HUD sprite offsets
local wraithMeterXOffset2 = 80 --Wraith Meter HUD sprite offsets
...
function SamaelMod:PostPlayerInit(player)
    ...
    --Game():GetSeeds():AddSeedEffect(SeedEffect.SEED_KIDS_MODE) --Void the modded character crashing bug as of booster back 2
	end
end
