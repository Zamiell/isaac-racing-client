...
export function start(): void {
  ...
  // This is because during these checks, Steam might have to be restarted, and the user will
  // obviously be logged out during this time.

  // If we are on a test account, the account ID will be 0. We don't want to start the Steam watcher
  // if we are on a test account, since they are not associated with Steam accounts.
